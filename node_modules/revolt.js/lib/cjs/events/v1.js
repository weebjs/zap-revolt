        ...
        switch (event.type) {
            ...
            case "MessageUpdate": {
                ...
                if (message) {
                    ...
                    client.messages.updateUnderlyingObject(event.id, Object.assign(Object.assign({}, (0, hydration_1.hydrate)("message", event.data, client, false)), { editedAt: new Date() }));
            ...
            case "ChannelUpdate": {
                ...
                if (channel) {
                    ...
                    const changes = (0, hydration_1.hydrate)("channel", event.data, client, false);
                    if (event.clear) {
            ...
            case "ServerUpdate": {
                ...
                if (server) {
                    ...
                    const changes = (0, hydration_1.hydrate)("server", event.data, client, false);
                    if (event.clear) {
                        for (const remove of event.clear) {
                            switch (remove) {
                                case "Banner":
                ...
                if (!client.serverMembers.hasByKey(id)) {
                    if (!client.users.has(id.user)) {
                        if (client.options.eagerFetching) {
                            yield client.users.fetch(id.user);
                        }
                    }
            ...
            case "ServerMemberUpdate": {
                ...
                if (member) {
                    ...
                    const changes = (0, hydration_1.hydrate)("serverMember", event.data, client, false);
                    if (event.clear) {
                        for (const remove of event.clear) {
                            switch (remove) {
                                case "Nickname":
            ...
            case "UserUpdate": {
                ...
                if (user) {
                    ...
                    const changes = (0, hydration_1.hydrate)("user", event.data, client, false);
                    if (event.clear) {
                        for (const remove of event.clear) {
                            switch (remove) {
                                case "Avatar":
