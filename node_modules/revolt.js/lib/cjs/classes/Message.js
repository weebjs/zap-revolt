...
class Message {
     ...
     */
    get $exists() {
        return !!__classPrivateFieldGet(this, _Message_collection, "f").getUnderlyingObject(this.id).id;
    }
    /**
    ...
    get content() {
        var _a;
        return (_a = __classPrivateFieldGet(this, _Message_collection, "f").getUnderlyingObject(this.id).content) !== null && _a !== void 0 ? _a : "";
    }
    /**
    ...
    get mentioned() {
        var _a;
        return (_a = this.mentionIds) === null || _a === void 0 ? void 0 : _a.includes(__classPrivateFieldGet(this, _Message_collection, "f").client.user.id);
    }
    /**
