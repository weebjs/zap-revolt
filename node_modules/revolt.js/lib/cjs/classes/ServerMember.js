...
class ServerMember {
     ...
     */
    get $exists() {
        return !__classPrivateFieldGet(this, _ServerMember_collection, "f").getUnderlyingObject(key(this.id)).id;
    }
    /**
    ...
    get displayName() {
        var _a, _b;
        return (_a = this.nickname) !== null && _a !== void 0 ? _a : (_b = this.user) === null || _b === void 0 ? void 0 : _b.displayName;
    }
    /**
