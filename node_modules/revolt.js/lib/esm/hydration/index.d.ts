...
declare const hydrators: {
    ...
    channelUnread: Hydrate<import("../lib/merge").Merge<{
        _id: {
            channel: string;
            user: string;
        };
    ...
    }>, import("./channelUnread").HydratedChannelUnread>;
    channelWebhook: Hydrate<import("../lib/merge").Merge<{
        id: string;
        name: string;
        avatar?: {
            _id: string;
    ...
    }>, import("./channelWebhook").HydratedChannelWebhook>;
    ...
    session: Hydrate<{
        _id: string;
        name: string;
    }, import("./session").HydratedSession>;
    user: Hydrate<{
        _id: string;
        username: string;
 ...
 */
export declare function hydrate<T extends keyof Hydrators>(type: T, input: Partial<ExtractInput<Hydrators[T]>>, context: unknown, initial?: boolean): ExtractOutput<{
    bot: Hydrate<{
        _id: string;
        owner: string;
        token: string;
