...
export class ChannelWebhook {
     ...
     */
    async edit(data) {
        const webhook = await this.#collection.client.api.patch(`/webhooks/${this.id}/${this.token}`, data);
        this.#collection.updateUnderlyingObject(this.id, hydrate("channelWebhook", webhook, this.#collection.client));
    }
    /**
     * Delete this webhook
     */
    async delete() {
        await this.#collection.client.api.delete(`/webhooks/${this.id}/${this.token}`);
